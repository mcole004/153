...
/////////////////////////////////
int i, argc = 0, argv_size = 2, counter = 0;
  char *token;

char **argv = malloc(2*sizeof(char *));
char **cont = malloc(2*sizeof(char *));
//uint8_t *esp = thread_current()->stack;//put argv on stack

for(token = (char*) file_name; token != NULL; token = strtok_r(NULL, " ", saveptr))//parse through the commands and put them in an array
{	
//	*esp -= strlen(token) +1;
